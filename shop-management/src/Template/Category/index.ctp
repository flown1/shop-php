...
<div class="category index large-9 medium-8 columns content">
    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                <th scope="col"><?= $this->Paginator->sort('id_product_category') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $category->id_product_category]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $category->id_product_category]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $category->id_product_category], ['confirm' => __('Are you sure you want to delete # {0}?', $category->id_product_category)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
