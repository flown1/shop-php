    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $product->id_product]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $product->id_product]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $product->id_product], ['confirm' => __('Are you sure you want to delete # {0}?', $product->id_product)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
